...
public class YasuoSkill : ScriptableObject
{
    ...
    void LoadData()
    {
        this.AddData(AttackType.NormalAttack, DamageType.Physical, 20, 105, 0, true, 4);
        this.AddData(AttackType.Skill1, DamageType.Physical, 45, 105, 0, true, 12);
        this.AddData(AttackType.Skill2, DamageType.Physical, 70, 20, 60, false, 10);
    }
