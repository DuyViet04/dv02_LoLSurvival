...
namespace _Data.Refactor.Editor
{
    public class EnemyMigrationTool
    {
        ...
        private static void CreateEnemySo(MigrationData data)
        {
            ...
            SetPrivateField(so.enemyData, "<EnemyType>k__BackingField", data.Type);
            SetPrivateField(so.enemyData, "<ExpValue>k__BackingField", CreateStat(StatType.ExpValue, data.Exp));
            SetPrivateField(so.enemyData, "<GoldValue>k__BackingField", CreateStat(StatType.GoldValue, data.Gold));
            SetPrivateField(so.enemyData, "<CsValue>k__BackingField", CreateStat(StatType.CsValue, data.Cs));
            SetPrivateField(so.enemyData, "<SpawnDelay>k__BackingField", CreateStat(StatType.SpawnDelay, data.SpawnDelay));
            SetPrivateField(so.enemyData, "<SpawnCount>k__BackingField", CreateStat(StatType.SpawnValue, data.SpawnCount));
            ...
            SetPrivateField(so.offensiveData, "attackSpeed", CreateStat(StatType.AttackSpeed, data.AttackSpeed));
            ...
            SetPrivateField(so.offensiveData, "armorPenetrationPercent", CreateStat(StatType.ArmorPenetrationPercent, 0f));
            SetPrivateField(so.offensiveData, "magicPenetration", CreateStat(StatType.MagicPenetration, 0f));
            SetPrivateField(so.offensiveData, "magicPenetrationPercent", CreateStat(StatType.MagicPenetrationPercent, 0f));
        ...
        private static List<MigrationData> GetEnemyMigrationData()
        {
            ...
            {
                new MigrationData(EnemyType.Blue, 230, 42, 42, 2.75f, 95, 90, 4, 360, 1, 66, DamageType.Magical, 0f),
                new MigrationData(EnemyType.Red, 230, 42, 42, 2.75f, 95, 90, 4, 420, 1, 66, DamageType.Magical, 0f),
                new MigrationData(EnemyType.MeleeEnemy, 46.5f, 20, 1, 1.5f, 61.75f, 21, 1, 3, 3, 11, DamageType.Physical, 0f),
                new MigrationData(EnemyType.RangeEnemy, 28.4f, 1, 1, 1.5f, 30.4f, 14, 1, 6, 3, 21, DamageType.Physical, 0.25f),
                new MigrationData(EnemyType.CannonEnemy, 83.5f, 1, 1, 1.5f, 95, 60, 1, 30, 1, 37.5f, DamageType.Physical, 0.33f),
                new MigrationData(EnemyType.SuperEnemy, 160, 100, -30, 1.5f, 95, 60, 1, 60, 1, 215, DamageType.Physical, 0f),
                new MigrationData(EnemyType.Gromp, 205, 42, 42, 3.3f, 120, 80, 4, 120, 1, 70, DamageType.Magical, 0f),
                new MigrationData(EnemyType.MurkWolfL, 160, 42, 42, 5.25f, 50, 50, 2, 180, 1, 30, DamageType.Magical, 0f),
                new MigrationData(EnemyType.MurkWolfS, 63, 20, 20, 5.25f, 15, 15, 1, 180, 2, 10, DamageType.Magical, 0f),
                new MigrationData(EnemyType.RaptorL, 120, 42, 42, 4.5f, 20, 30, 2, 240, 1, 17, DamageType.Magical, 0f),
                new MigrationData(EnemyType.RaptorS, 50, 20, 20, 5.25f, 10, 8, 0.4f, 240, 5, 7, DamageType.Magical, 0f),
                new MigrationData(EnemyType.KrugL, 135, 42, 42, 2.5f, 15, 15, 2, 300, 1, 57, DamageType.Magical, 0f),
                new MigrationData(EnemyType.KrugM, 65, 20, 20, 3.5f, 10, 10, 0.5f, 300, 2, 20, DamageType.Magical, 0f),
                new MigrationData(EnemyType.KrugS, 6, 20, 20, 4, 16, 14, 0.25f, 300, 2, 13, DamageType.Magical, 0f)
            };
        }
        ...
        private struct MigrationData
        {
            ...
            public MigrationData(EnemyType type, float health, float armor, float mr, float moveSpeed, float exp, float gold, float cs, float spawnDelay, float spawnCount, float damage, DamageType dmgType, float attackSpeed)
            {
                Type = type;
                Health = health;
                Armor = armor;
